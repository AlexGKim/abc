...
%\begin{multline}
%p(n, {{T}}_S,{{z}}_S, \theta_{S}, \theta_G |  \Omega_M, w, \theta_r, \alpha_{Ia}, \beta_{Ia},\sigma_{Ia}, \alpha_{\mathit{non-Ia}},\beta_{\mathit{non-Ia}}, \sigma_{\mathit{non-Ia}},  Z, g, g_N, f_g)\\
%= \frac{\epsilon(n, {{T}}_S,{{z}}_S, \theta_{S}, \theta_G) p_U(n, {{T}}_S,{{z}}_S, \theta_{S}, \theta_G | \ldots)}
%{\sum_{T_S} \int dn\, dz_S\, d\theta_S\, d\theta_G\, \epsilon(n, {{T}}_S,{{z}}_S, \theta_{S}, \theta_G) p_U(n, {{T}}_S,{{z}}_S, \theta_{S}, \theta_G | \ldots)},
%\end{multline} 
...
%The likelihood without the configuration condition for our measurements is
%\begin{multline}
%p(n_{SN}, {{T}}_S,{{z}}_S, \theta_{S}, \theta_G | L, \ldots) \\
%= \delta(z_S - g_z) \delta(\theta_S-\theta_T) \delta(\theta_G -g) \delta(T_S-T)  \mathcal{N}
%\left(n_{SN} -\overline{n}_j(L ,\ldots), C_P \right).
%\end{multline}. 
%
...
%\begin{equation}
%P(b_{ij} | L, \ldots) = b_{ij} + (-1)^{b_{ij}}\int_{-\infty}^{ADU_0} dn_{SN,i}  \mathcal{N}\left(n_{SN} - \overline{n}_j(L ,\ldots), C_P \right),
%\end{equation}
%the (complementary) cumulative distribution function for a normal distribution
%with variable
%$n_0$, i.e.\ 2 times the error function.
...
%\begin{multline}
%p(n_{SN}, \theta_G |  \Omega_M, w, \theta_r, \alpha_{Ia}, \beta_{Ia},\sigma_{Ia}, \alpha_{\mathit{non-Ia}},\beta_{\mathit{non-Ia}}, \sigma_{\mathit{non-Ia}},  Z, g, g_N, f_g)\\
%= \sum_i \int_L dL\, p(n_{SN}, \theta_G | b_i, L, \ldots)
%P(b_{i} |L, \ldots) P(L|\ldots) ,
%\end{multline} 
%\begin{equation}
%p(n_{SN}, \theta_G | b_i, L, \ldots)
%  =  \frac{ \prod_j
% \epsilon(n_{SN,j}; b_{ij})
%  p(n_{SN}, \theta_G | L, \ldots)}
