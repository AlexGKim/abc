...
pgm.add_node(Node('Luminosity',r"$L_i(t,\lambda)$", 5, 4, fixed=True, scale=1.2, offset=(-20,8)))
...
pgm.add_node(Node('Counts_g',r"$\overline{\mathit{ADU}}_{gi}$", 8, 1,scale=1.2,fixed=True,offset=(0,-25)))
